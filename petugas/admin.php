    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="?page=registrasi" class="nav-link">
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b>TUBES Pemrograman Lanjut 5TI2 2025</b>
            </div>
            <strong>Copyright &copy; 2025 <a href="https://www.instagram.com/made_adityaa_" target="_blank">I Made Aditya</a>. NPM 2311010029</strong> Pemrograman Lanjut 5TI2
        </footer>
    </div>
    <!-- ./wrapper -->
