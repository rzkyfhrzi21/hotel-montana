    ...
    <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                $sql_kamar = mysqli_query($koneksi, "SELECT * from kamar order by id_kamar desc");
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="../functions/kamar.php" method="post" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="ket_kamar">Ket Kamar</label>
                                            <textarea name="ket_kamar" class="form-control" placeholder="Masukkan Keterangan Kamar" id="ket_kamar" rows="3" required><?= $kamar['ket_kamar']; ?></textarea>
                                        </div>
                                        <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../functions/kamar.php" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="ket_kamar">Ket Kamar</label>
                        <textarea name="ket_kamar" class="form-control" placeholder="Masukkan Ket Kamar" id="ket_kamar" rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="ukuran_kamar">Ukuran Kamar</label>
