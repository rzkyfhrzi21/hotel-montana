...
if (isset($_POST['tambah_kamar'])) {
    ...
    if ($_FILES['gambar_kamar']['error'] == 4) {
        ...
        $query  = "INSERT into kamar set nama_kamar = '$nama_kamar', harga_kamar = '$harga_kamar', ukuran_kamar = '$ukuran_kamar', ket_kamar = '$ket_kamar', jumlah_kasur = '$jumlah_kasur', gambar_kamar = '$gambar_kamar'";
...
if (isset($_POST['ubah_kamar'])) {
    ...
    if ($_FILES['gambar_kamar']['error'] == 4) {
        $query  = "UPDATE kamar set nama_kamar = '$nama_kamar', harga_kamar = '$harga_kamar', ukuran_kamar = '$ukuran_kamar', ket_kamar = '$ket_kamar', jumlah_kasur = '$jumlah_kasur' where id_kamar = '$id_kamar'";
    } else {
        unlink('../img/kamar/' . $gambar_lama);
        $gambar_kamar   = uploadKamar();

        $query  = "UPDATE kamar set nama_kamar = '$nama_kamar', harga_kamar = '$harga_kamar', ukuran_kamar = '$ukuran_kamar', ket_kamar = '$ket_kamar', jumlah_kasur = '$jumlah_kasur', gambar_kamar = '$gambar_kamar', gambar_kamar = '$gambar_kamar' where id_kamar = '$id_kamar'";
    }
